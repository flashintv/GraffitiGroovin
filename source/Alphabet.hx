		...
		for (character in splitWords)
		{
			...
			if ((isAlphabet || isSymbol || isNumber) && (!isBold || !spaceChar))
			{
				...
				else
				{
					if (isNumber)
					{
						letter.createNumber(character, false);
					}
					else if (isSymbol)
					{
						letter.createSymbol(character, false);
					}
					else
					{
						letter.createLetter(character, false);
					}
				}
...
class AlphaCharacter extends FlxSprite
{
	...
	public function createLetter(letter:String, typed:Bool = true):Void
	{
	...
	public function createNumber(letter:String, typed:Bool = true):Void
	{
	...
	public function createSymbol(letter:String, typed:Bool = true)
	{
		switch (letter)
		{
			case '#':
