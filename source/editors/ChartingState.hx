...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Philly Glow', "Exclusive to City (philly) stage\nNo values."],
		['Subway Train', "Exclusive to Neon Subway (subway2) stage\nValue 1: 1 or 2."],
		['Set Property', "Value 1: Variable name\nValue 2: New value"],
		['Black Bars', "Value 1: Amount, takes number as pixels, number% as percent\nValue 2: \"duration,ease\" leave empty for instant"],
		['Streetstyle Neon', "Value 1: 0 = Turn off, 1 = Tunnel part,\n2 = Skarlet Solo"]
	];
